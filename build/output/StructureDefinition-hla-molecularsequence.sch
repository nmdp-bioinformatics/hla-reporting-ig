...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MolecularSequence">
      ...
      <sch:assert test="count(f:referenceSeq) &gt;= 1">referenceSeq: minimum cardinality of 'referenceSeq' is 1</sch:assert>
      <sch:assert test="count(f:observedSeq) &gt;= 1">observedSeq: minimum cardinality of 'observedSeq' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MolecularSequence/f:referenceSeq">
      ...
      <sch:assert test="count(f:windowStart) &gt;= 1">windowStart: minimum cardinality of 'windowStart' is 1</sch:assert>
      <sch:assert test="count(f:windowEnd) &gt;= 1">windowEnd: minimum cardinality of 'windowEnd' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
