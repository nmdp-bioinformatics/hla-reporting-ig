...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticReport">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/RecommendedAction']) &lt;= 0">extension with URL = 'http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/RecommendedAction': maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.nmdp.org/ig/hla-reporting/StructureDefinition/hla-genotype-summary']) &gt;= 1">extension with URL = 'http://fhir.nmdp.org/ig/hla-reporting/StructureDefinition/hla-genotype-summary': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.nmdp.org/ig/hla-reporting/StructureDefinition/hla-genotype-summary']) &lt;= 1">extension with URL = 'http://fhir.nmdp.org/ig/hla-reporting/StructureDefinition/hla-genotype-summary': maximum cardinality of 'extension' is 1</sch:assert>
